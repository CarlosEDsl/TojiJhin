...
], WorkoutController.prototype, "getAllWorkouts", null);
__decorate([
    (0, tsoa_1.Get)('{id}'),
    ...
    __metadata("design:returntype", Promise)
], WorkoutController.prototype, "getWorkout", null);
__decorate([
    (0, tsoa_1.Post)('/'),
    __param(0, (0, tsoa_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Workout_1.Workout]),
    __metadata("design:returntype", Promise)
], WorkoutController.prototype, "createWorkout", null);
exports.WorkoutController = WorkoutController = __decorate([
    (0, tsoa_1.Route)('workouts'),
    (0, tsoa_1.Tags)('Workouts')
], WorkoutController);
